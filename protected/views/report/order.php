...
<center>
	<h1>
	รายงานจำนวน Order ประจำเดือน <?php echo $data[0]['monthNow']; ?> ปี <?php echo $data[0]['yearNow']; ?>
	</h1>
			<div class="CSSTableGenerator">
                <table >
                    ...
                    <tr>
                        ...
                        <td width="25%">
                            <?php echo  $data[$i]["totalWait"]." รายการ "?>
                        </td>
                    </tr>
                	<?php } ?>
                 	<tr>
