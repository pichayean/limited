...
<div class="shell">
  ...
  <div id="header">
    ...
    <div id="navigation">
      <ul>
        <li><a href="<?php echo Yii::app()->createUrl('site/index'); ?>" class= "active">Home</a></li>
  ...
  <div id="main">
    ...
    <div id="sidebar">
      ...
      <div  class="box search" >
        <center>
          <?php if (Yii::app()->session["sportshop_online"] == 0) {
            $this->renderPartial('//layouts/sideLogin'); 
          }else{
            $this->renderPartial('//layouts/sideProfile'); 
          } ?>
        </center>
      </div>
      <!-- End Search -->
          ...
          <ul>            
            <?php 
              ...
              foreach($param as $value){ 
                    echo $text1.'<a href="index.php?r=site/shop2&categoryId='.$value->id.'">'.$value->name.$text2;
              }
            ?>
          </ul>
        </div>
  ...
  <div id="footer">
    ...
    <?php 
    if (Yii::app()->session["sportshop_online"] === 1 && Yii::app()->session["sportshop_level"] <> 'customer') {
